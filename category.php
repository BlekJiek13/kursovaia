<?php
	...
	//$posts = selectAllFromPostsUsersIndex('articles','users');
	// test($posts);
	// exit();
	$posts = selectAll('articles',['id_category' => $_GET['id']] ); 
	$category = selectOne('name_category', ['id_name_category' => $_GET['id']]);
	...
	<div class="container">
		<div class="content row">
			<div class="main-content col-md-9">
				<h2>Сортировка статей по категории: <strong><?=$category['name_category'] ?></strong></h2>
				<?php  foreach($posts as $post): ?>
					<?php $author= selectOne('users',['id_users' =>$post['id_user']]);?>
				...
				<div class="post row">
					...
					<div class="post_text col-12 col-md-8"> <!--описание--->
						...
						<i class="fa-solid fa-pen"> <label style="	font-family: 'Times New Roman', Times, serif;"><?=$author['login']; ?> </label></i>
